...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) { 
    ...
    // Delete record from the inventory table
    $sql_delete = "DELETE FROM inventory WHERE prod_id = '$delete_id'";
    if ($conn->query($sql_delete) === TRUE) { 
        $conn->close();
        header('Location: invent.php'); // Redirect to invent.php after deleting product
        exit();
    } else { 
