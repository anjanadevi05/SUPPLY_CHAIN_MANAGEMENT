...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) { 
    ...
    // Delete record from the manufacturer table
    $sql_delete = "DELETE FROM manufacturer WHERE man_id = '$delete_id'";
    if ($conn->query($sql_delete) === TRUE) { 
        $conn->close();
        header('Location: Manu.php'); // Redirect to Manu.php after deleting manufacturer
        exit();
    } else { 
...
<body> 
    ...
    <form method="post" action="" class="delete-form"> 
        <label for="delete_id">Manufacturer ID to Delete:</label> 
